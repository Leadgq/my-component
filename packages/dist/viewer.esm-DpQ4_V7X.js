...
function B(n) {
  ...
  try {
    ...
    return t && i && pe.call(i, "isPrototypeOf");
  } catch {
    return !1;
  }
}
...
}, be = /^(?:width|height|left|top|marginLeft|marginTop)$/;
function k(n, t) {
  var i = n.style;
  w(t, function(e, a) {
    be.test(a) && T(e) && (e += "px"), i[a] = e;
  });
}
function we(n) {
...
var ye = /([a-z\d])([A-Z])/g;
function Tt(n) {
  return n.replace(ye, "$1-$2").toLowerCase();
}
function K(n, t) {
...
var xe = {
  ...
  initList: function() {
    ...
    a.innerHTML = "", w(this.images, function(s, l) {
      var u = s.src, h = s.alt || Te(u), o = t.getImageURL(s);
      if (u || o) {
      ...
      bt(l, "filled", !0), e.loading && f(s, G), d(l, z, u = function(c) {
        b(l, X, h), e.loading && g(s, G), t.loadImage(c);
      }, {
        once: !0
      }), d(l, X, h = function() {
        b(l, z, u), e.loading && g(s, G);
      }, {
        once: !0
      });
  ...
  unbind: function() {
    var t = this.options, i = this.viewer, e = this.canvas, a = this.element.ownerDocument;
    b(i, $, this.onClick), b(i, At, this.onDragStart), b(e, _t, this.onPointerDown), b(a, zt, this.onPointerMove), b(a, Lt, this.onPointerUp), b(a, Ct, this.onKeyDown), b(window, kt, this.onResize), t.zoomable && t.zoomOnWheel && b(i, Rt, this.onWheel, {
      passive: !1,
      capture: !0
  ...
  load: function() {
    ...
    g(a, et), e.loading && g(this.canvas, G), a.style.cssText = "height:0;" + "margin-left:".concat(s.width / 2, "px;") + "margin-top:".concat(s.height / 2, "px;") + "max-width:none!important;position:relative;width:0;", this.initImage(function() {
      at(a, fe, e.movable), at(a, D, e.transition), t.renderImage(function() {
  ...
  loadImage: function(t) {
    ...
    ee(i, this.options, function(l, u) {
      var h = l / u, o = a, c = r;
      r * h > a ? s ? o = r * h : c = a / h : s ? c = a / h : o = r * h, k(i, C({
        width: o,
        height: c
      }, ct({
        translateX: (a - o) / 2,
  ...
  view: function() {
    ...
    v && (g(v, rt), v.removeAttribute("aria-selected")), f(l, rt), l.setAttribute("aria-selected", !0), a.focus && l.focus(), this.image = c, this.viewed = !1, this.index = i, this.imageData = {}, f(c, et), a.loading && f(s, G), s.innerHTML = "", s.appendChild(c), this.renderList(), r.innerHTML = "";
    var x = function() {
      var A = t.imageData, O = Array.isArray(a.title) ? a.title[1] : a.title;
      r.innerHTML = we(p(O) ? O.call(t, c, A) : "".concat(o, " (").concat(A.naturalWidth, " × ").concat(A.naturalHeight, ")"));
    }, S, E;
    return d(e, it, x, {
      once: !0
    }), this.viewing = {
      ...
      b(c, z, S), t.timeout && (clearTimeout(t.timeout), t.timeout = !1), g(c, et), a.loading && g(t.canvas, G);
    }, {
      once: !0
  ...
  zoomTo: function(t) {
    ...
    if (t = Math.max(0, t), T(t) && this.viewed && !this.played && (s || u.zoomable)) {
      ...
      if (p(u.zoom) && d(l, Kt, u.zoom, {
        ...
        return this;
      if (this.zooming = !0, r) {
        var Q = Ee(this.viewer), H = h && Object.keys(h).length > 0 ? De(h) : {
          pageX: r.pageX,
          pageY: r.pageY
        };
...
}, Ce = F.Viewer, _e = /* @__PURE__ */ function(n) {
  return function() {
    return n += 1, n;
  };
}(-1), ze = /* @__PURE__ */ function() {
  function n(t) {
    var i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    if (ie(this, n), !t || t.nodeType !== 1)
      throw new Error("The first argument is required and must be an element.");
    this.element = t, this.options = C({}, xt, B(i) && i), this.action = !1, this.fading = !1, this.fulled = !1, this.hiding = !1, this.imageClicked = !1, this.imageData = {}, this.index = this.options.initialViewIndex, this.isImg = !1, this.isShown = !1, this.length = 0, this.moving = !1, this.played = !1, this.playing = !1, this.pointers = {}, this.ready = !1, this.rotating = !1, this.scaling = !1, this.showing = !1, this.timeout = !1, this.tooltipping = !1, this.viewed = !1, this.viewing = !1, this.wheeling = !1, this.zooming = !1, this.pointerMoved = !1, this.id = _e(), this.init();
  }
  return ne(n, [{
    key: "init",
    value: function() {
    ...
    value: function() {
      if (!this.ready) {
        ...
        if (this.parent = a, this.viewer = s, this.title = l, this.toolbar = u, this.navbar = h, this.button = o, this.canvas = c, this.footer = s.querySelector(".".concat(m, "-footer")), this.tooltipBox = s.querySelector(".".concat(m, "-tooltip")), this.player = s.querySelector(".".concat(m, "-player")), this.list = s.querySelector(".".concat(m, "-list")), s.id = "".concat(m).concat(this.id), l.id = "".concat(m, "Title").concat(this.id), f(l, e.title ? ot(Array.isArray(e.title) ? e.title[0] : e.title) : W), f(h, e.navbar ? ot(e.navbar) : W), at(o, W, !e.button), e.keyboard && o.setAttribute("tabindex", 0), e.backdrop && (f(s, "".concat(m, "-backdrop")), !e.inline && e.backdrop !== "static" && bt(c, ft, "hide")), nt(e.className) && e.className && e.className.split(Et).forEach(function(y) {
          ...
          x || f(u, ot(e.toolbar)), w(x ? e.toolbar : st, function(y, V) {
            ...
            if (!(!Y || !e.zoomable && S.indexOf(R) !== -1 || !e.rotatable && E.indexOf(R) !== -1 || !e.scalable && N.indexOf(R) !== -1)) {
              ...
              e.keyboard && M.setAttribute("tabindex", 0), M.setAttribute("role", "button"), f(M, "".concat(m, "-").concat(R)), p(H) || bt(M, ft, R), T(Y) && f(M, ot(Y)), ["small", "large"].indexOf(Q) !== -1 ? f(M, "".concat(m, "-").concat(Q)) : R === "play" && f(M, "".concat(m, "-large")), p(H) && d(M, $, H), v.appendChild(M);
            }
          }), u.appendChild(v);
        } else
          f(u, W);
        ...
        if (e.inline)
          ...
          f(o, oe), f(s, gt), f(s, ut), f(s, W), k(s, {
            zIndex: e.zIndex
          });
          var O = e.container;
          nt(O) && (O = i.ownerDocument.querySelector(O)), O || (O = this.body), O.appendChild(s);
        }
